...
- (void)resetWithStartMuted:(BOOL)startMuted {
  ...
  UIImage *image = startMuted
    ? [UIImage imageNamed:@"video_mute"] : [UIImage imageNamed:@"video_unmute"];
...
- (void)setPlaying:(BOOL)playing {
  if ((!playing && self.playing) || (playing && !self.playing)) {
    UIImage *image = playing
      ? [UIImage imageNamed:@"video_pause"] : [UIImage imageNamed:@"video_play"];
