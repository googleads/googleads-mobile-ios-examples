...
static NSString *const kAdUnitID = @"/21775744923/example/swipeable-interstitial";

/// Objective-C code snippets for swipeable interstitial ad lifecycle events.
@interface AdManagerSwipeableInterstitialSnippets : NSObject <GADSwipeableInterstitialAdDelegate>
...
@interface AdManagerSwipeableInterstitialSnippets (Video) <GADVideoControllerDelegate>
- (void)registerVideoControllerDelegate;
@end

@implementation AdManagerSwipeableInterstitialSnippets (Video)
...
@implementation AdManagerSwipeableInterstitialSnippets
...
- (GADSwipeableInterstitialAdOptions *)swipeableInterstitialAdOptionsWithAdSize:(CGSize)adSize {
  ...
  // Custom ad sizes must fill at least 60% of the screen.
