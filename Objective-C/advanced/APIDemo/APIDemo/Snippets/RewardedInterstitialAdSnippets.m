...
static NSString *const publisherAdUnitID = @"/21775744923/example/rewarded-interstitial";
...
// [START load_ad_gam]
- (void)loadGAMRewardedInterstitialAd {
  [GADRewardedInterstitialAd loadWithAdUnitID:publisherAdUnitID
...
- (void)validateGAMServerSideVerification {
  // Replace this ad unit ID with your own ad unit ID.
  [GADRewardedInterstitialAd loadWithAdUnitID:publisherAdUnitID
                                      request:[GAMRequest request]
                            completionHandler:^(GADRewardedInterstitialAd *ad, NSError *error) {
