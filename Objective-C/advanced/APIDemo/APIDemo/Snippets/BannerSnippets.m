...
- (void)viewDidLoad {
  [super viewDidLoad];
  // AdMob setup.
  [self createAdMobBannerViewProgrammatically];
  // Ad Manager setup.
  [self createAdManagerBannerViewProgrammatically];
}
...
- (void)createAdMobBannerViewProgrammatically {
...
- (void)createAdManagerBannerViewProgrammatically {
