...
@interface AdManagerSCARSnippets
    : NSObject <GADNativeAdLoaderDelegate, GAMBannerAdLoaderDelegate, GADBannerViewDelegate>
...
- (void)loadNative:(NSString *)adUnitID rootViewController:(UIViewController *)rootViewController {
  ...
  signalRequest.adLoaderAdTypes = [NSSet setWithArray:@[ GADAdLoaderAdTypeNative ]];
...
- (void)renderNative:(NSString *)adUnitID
    ...
    rootViewController:(UIViewController *)rootViewController {
  // [START render_native]
  self.adLoader = [[GADAdLoader alloc] initWithRootViewController:rootViewController];
